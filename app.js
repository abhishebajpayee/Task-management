var form = document.getElementById("myForm"),
    ...
    post = document.getElementById("task"),
...
function readInfo(pic, name, age, city, email, phone, task, sDate){
    ...
    document.querySelector("#showPost").value = task,
